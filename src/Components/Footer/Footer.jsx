...
const Footer = () => {
    const footer1 = [
        ...
        },
        {
            ...
            sub: ["Contact Us", "FAQ", "T&C", "Terms of Use", "Track Order", "Shipping", "Cancellation", "Returns","Privacy policy"]
        },
        {
            title: "USEFUL LINKS",
    ...
    return (
        <div className="Footerbody">
            ...
            <div className="footer_popular_details">Kurta Pajama | Leather Jackets | Sherwani | Shirts | T-Shirts | Waistcoat | Photo Frames | Denim Shirts | Blazers | Mirror | Bags | Jackets | Blouse Designs | Crop Tops | Mysore Silk Saree | Kids Lehenga | Suit Design | Lehenga | Girl Dungarees | Top for Girl | Top for Girl | Lingerie | Gowns | Saree | Kids Ethnic Wear | Sweaters | Boys Games | Barbie Doll | Shoes For Men | Cricket Shoes | Lipstick | Make Up Kit | Fastrack Watches | Casual Shoes | Online Shopping | Dresses | Babydolls | Eye Makeup | Car Games | Nike Shoes | Puma | United Colors of Benetton | Fastrack | Watches | Backpacks | Men Kurtas | Titan Watches</div>
            <div className="footer5">
                <p className="bottom">In case of any concern, <span className="footerspan">Contact Us</span></p>
